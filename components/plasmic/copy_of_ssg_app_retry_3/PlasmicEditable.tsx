...
import sty from "./PlasmicEditable.module.css"; // plasmic-import: OKfc7zSjEnVH/css
    ...
    >
      <div
        className={classNames(
          ...
          "editableText",
          {
            [sty.freeBoxeditEnabled__gepItAqM]: hasVariant(
              $state,
              "editEnabled",
              "editEnabled"
            )
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__jShL, "textEditor", {
          [sty.freeBoxeditEnabled__jShLtAqM]: hasVariant(
            $state,
            "editEnabled",
            "editEnabled"
          )
      ...
      >
        {(hasVariant($state, "editEnabled", "editEnabled") ? true : false)
          ? renderPlasmicSlot({
              defaultContents: (
                <TextInput
                  className={classNames("__wab_instance", sty.textInput__mYeNf)}
                  endIcon={null}
                  startIcon={null}
                />
              ),
